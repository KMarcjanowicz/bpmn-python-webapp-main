...
def generate_layout(bpmn_graph, symmetric=False):
    ...
    detach_edges_from_boundary_events(nodes_copy_reversed, flows_copy_reversed)
...
def detach_edges_from_boundary_events(nodes_copy_reversed, flows_copy_reversed):
    pass
